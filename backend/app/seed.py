...
def seed() -> None:
    ...
    try:
            ...
            (
                ...
                [
                    (
                        1,
                        "SC-HR-4X8-11G",
                        "Hot-Rolled Steel Sheet 4x8ft 11 Gauge",
                        200,
                        Decimal("142.50"),
                        Decimal("28500.00"),
                    ),
                    (
                        2,
                        "SC-HR-4X8-14G",
                        "Hot-Rolled Steel Sheet 4x8ft 14 Gauge",
                        150,
                        Decimal("110.00"),
                        Decimal("16500.00"),
                    ),
            ...
            (
                ...
                [
                    (
                        1,
                        "TP-SENS-PT100-A",
                        "PT100 Temperature Sensor Type A",
                        50,
                        Decimal("145.00"),
                        Decimal("7250.00"),
                    ),
            ...
            (
                ...
                [
                    (
                        1,
                        "LT-FRT-INBOUND-Q1",
                        "Inbound Freight Services - January 2025",
                        1,
                        Decimal("8200.00"),
                        Decimal("8200.00"),
                    ),
            ...
            (
                ...
                [
                    (
                        1,
                        "SC-ROD-12MM-STD",
                        "Steel Round Rod 12mm Standard Grade",
                        500,
                        Decimal("28.00"),
                        Decimal("14000.00"),
                    ),
                    (
                        2,
                        "SC-ROD-20MM-STD",
                        "Steel Round Rod 20mm Standard Grade",
                        200,
                        Decimal("40.00"),
                        Decimal("8000.00"),
                    ),
        ...
        for po_number, v_code, po_status, order_dt, delivery_dt, lines in po_data:
            ...
            po_line_items = []
            for line_num, _part_num, desc, qty, price, lt in lines:
                pli = POLineItem(
                    po_id=po.id,
        ...
        grn1 = GoodsReceipt(
            ...
            po_id=purchase_orders["PO-2025-001"].id,
            vendor_id=vendors["SUP001"].id,
            receipt_date=date(2025, 1, 21),
            warehouse="WH-CHI-01",
        )
        db.add(grn1)
        db.flush()
        for pli in po_lines_map["PO-2025-001"]:
            db.add(
                GRNLineItem(
                    ...
                    condition_notes="Full delivery received in good condition.",
                )
            )
        ...
        grn2 = GoodsReceipt(
            ...
            po_id=purchase_orders["PO-2025-002"].id,
            vendor_id=vendors["SUP002"].id,
            receipt_date=date(2025, 1, 24),
            warehouse="WH-CHI-01",
        )
        db.add(grn2)
        db.flush()
        for pli in po_lines_map["PO-2025-002"]:
            db.add(
                GRNLineItem(
                    ...
                    po_line_id=pli.id,
                    quantity_received=pli.quantity_ordered,
                    condition_notes="All components tested and accepted by QC team.",
                )
            )
            pli.quantity_received = pli.quantity_ordered
        ...
        grn3 = GoodsReceipt(
            ...
            po_id=purchase_orders["PO-2025-003"].id,
            vendor_id=vendors["SUP003"].id,
            receipt_date=date(2025, 1, 31),
            warehouse=None,
        )
        db.add(grn3)
        db.flush()
        for pli in po_lines_map["PO-2025-003"]:
            db.add(
                GRNLineItem(
                    ...
                    po_line_id=pli.id,
                    quantity_received=pli.quantity_ordered,
                    condition_notes="Service completion confirmed by SCM department.",
                )
            )
            pli.quantity_received = pli.quantity_ordered
        ...
        grn4 = GoodsReceipt(
            ...
            po_id=purchase_orders["PO-2025-004"].id,
            vendor_id=vendors["SUP004"].id,
            receipt_date=date(2025, 1, 27),
            warehouse="WH-CHI-02",
        )
        db.add(grn4)
        db.flush()
        for pli in po_lines_map["PO-2025-004"]:
            db.add(
                GRNLineItem(
                    ...
                    po_line_id=pli.id,
                    quantity_received=pli.quantity_ordered,
                    condition_notes="All PPE items received and distributed to EHS store.",
                )
            )
            pli.quantity_received = pli.quantity_ordered
        ...
        grn5 = GoodsReceipt(
            ...
            po_id=purchase_orders["PO-2025-005"].id,
        ...
        db.add(
            GRNLineItem(
                grn_id=grn5.id,
                po_line_id=po5_lines[0].id,
                quantity_received=Decimal("2"),
                condition_notes="PARTIAL RECEIPT: Turrets received.",
            )
        )
        ...
        db.add(
            GRNLineItem(
                grn_id=grn5.id,
                po_line_id=po5_lines[1].id,
                quantity_received=Decimal("2"),
                condition_notes="PARTIAL: 2 of 3 spindles received.",
            )
        )
        ...
        db.add(
            GRNLineItem(
                grn_id=grn5.id,
                po_line_id=po5_lines[2].id,
                quantity_received=Decimal("0"),
                condition_notes="Not yet shipped — supplier confirmed delivery Feb 28",
            )
        )
        ...
        grn6 = GoodsReceipt(
            grn_number="GRN-2025-006",
            po_id=purchase_orders["PO-2025-006"].id,
            vendor_id=vendors["SUP001"].id,
            receipt_date=date(2025, 2, 4),
            warehouse="WH-CHI-01",
        )
        db.add(grn6)
        db.flush()
        for pli in po_lines_map["PO-2025-006"]:
            db.add(
                GRNLineItem(
                    ...
                    po_line_id=pli.id,
                    quantity_received=pli.quantity_ordered,
                    condition_notes="Full delivery received.",
                )
            )
            pli.quantity_received = pli.quantity_ordered
        ...
        grn7 = GoodsReceipt(
            grn_number="GRN-2025-007",
            po_id=purchase_orders["PO-2025-007"].id,
            vendor_id=vendors["SUP002"].id,
            receipt_date=date(2025, 2, 9),
            warehouse="WH-CHI-01",
        )
        db.add(grn7)
        db.flush()
        for pli in po_lines_map["PO-2025-007"]:
            db.add(
                GRNLineItem(
                    ...
                    po_line_id=pli.id,
                    quantity_received=pli.quantity_ordered,
                    condition_notes="All boards received. QC testing passed.",
                )
            )
            pli.quantity_received = pli.quantity_ordered
        ...
        grn8 = GoodsReceipt(
            grn_number="GRN-2025-008",
            po_id=purchase_orders["PO-2025-008"].id,
            vendor_id=vendors["SUP003"].id,
            receipt_date=date(2025, 1, 28),
            warehouse=None,
        )
        db.add(grn8)
        db.flush()
        for pli in po_lines_map["PO-2025-008"]:
            db.add(
                GRNLineItem(
                    ...
                    po_line_id=pli.id,
                    quantity_received=pli.quantity_ordered,
                    condition_notes="Express freight service completed on time.",
                )
            )
            pli.quantity_received = pli.quantity_ordered
        ...
        grn9 = GoodsReceipt(
            grn_number="GRN-2025-009",
            po_id=purchase_orders["PO-2025-009"].id,
            vendor_id=vendors["SUP004"].id,
            receipt_date=date(2025, 2, 7),
            warehouse="WH-CHI-02",
        )
        db.add(grn9)
        db.flush()
        for pli in po_lines_map["PO-2025-009"]:
            db.add(
                GRNLineItem(
                    ...
                    po_line_id=pli.id,
                    quantity_received=pli.quantity_ordered,
                    condition_notes="All extinguishers received with valid certification.",
                )
            )
            pli.quantity_received = pli.quantity_ordered
        ...
        grn10 = GoodsReceipt(
            grn_number="GRN-2025-010",
            po_id=purchase_orders["PO-2025-010"].id,
            vendor_id=vendors["SUP005"].id,
            receipt_date=date(2025, 2, 11),
            warehouse="WH-CHI-01",
        )
        db.add(grn10)
        db.flush()
        for pli in po_lines_map["PO-2025-010"]:
            db.add(
                GRNLineItem(
                    ...
                    po_line_id=pli.id,
                    quantity_received=pli.quantity_ordered,
                    condition_notes="All cutting tools received and passed inspection.",
                )
            )
            pli.quantity_received = pli.quantity_ordered
        ...
        db.add(
            InvoiceLineItem(
                invoice_id=inv_extracted.id,
                line_number=1,
                description="Express Freight - Urgent Parts Delivery",
                quantity=Decimal("1"),
                unit_price=Decimal("4100.00"),
                line_total=Decimal("4100.00"),
                tax_amount=Decimal("0"),
                ai_gl_prediction="6100-00",
                ai_confidence=0.91,
            )
        )
        ...
        db.add(
            MatchResult(
                ...
                overall_score=100.0,
                details={
                    "lines": [{"line": 1, "status": "matched"}, {"line": 2, "status": "matched"}],
                    "duplicate_of": str(inv_posted_2.id),
                },
                matched_po_id=purchase_orders["PO-2025-002"].id,
                matched_grn_ids=[str(grn2.id)],
        ...
        db.add(
            MatchResult(
                ...
                overall_score=0.0,
                details={
                    "reason": "No matching PO found for vendor Apex Chemicals International. Vendor not in approved supplier list."
                },
                tolerance_applied=False,
            )
        )
